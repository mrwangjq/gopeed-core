...
import (
	...
	"github.com/mrwangjq/gopeed-core/internal/protocol/http"
...
func (b *boot) Create(opts *base.Options) error {
	...
	defaultDownloader := NewDownloader(http.FetcherBuilder)
	res, err := defaultDownloader.Resolve(&base.Request{
		URL:   b.url,
		Extra: b.extra,
	})
	if err != nil {
